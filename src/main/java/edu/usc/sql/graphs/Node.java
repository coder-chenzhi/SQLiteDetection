...
public class Node<T> implements NodeInterface {
	...
	private Set<NodeInterface> domSet = new HashSet<>();
	protected Map<String,Object> attributes;

	public Node(String name, Set<EdgeInterface> inEdges, Set<EdgeInterface> outEdges, Map<String,Object> attributes) {
	...
	public Node(String name, Set<EdgeInterface> inEdges, Set<EdgeInterface> outEdges) {
		this.inEdges = inEdges;
		this.outEdges = outEdges;
		this.name = name;
	...
	public Set<NodeInterface> getDomSet() {
		return domSet;
	}
